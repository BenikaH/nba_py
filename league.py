...
class PlayerTracking_Drives(_PlayerTrackingStats):
    """
    Statistics that measure drives by a player while on the court.
    """
    _pt_measure_type=PtMeasureType.Drives


class PlayerTracking_Defense(_PlayerTrackingStats):
    """
    Statistics that measure defense by a player while on the court.
    """
    _pt_measure_type=PtMeasureType.Defense



class PlayerTracking_CatchShoot(_PlayerTrackingStats):
    """
    Statistics that measure catch and shoot shooting by a player while on the court.
    """
    _pt_measure_type=PtMeasureType.CatchShoot


class PlayerTracking_Passing(_PlayerTrackingStats):
    """
    Statistics that measure passing by a player while on the court.
    """
    _pt_measure_type=PtMeasureType.Passing


class PlayerTracking_Possessions(_PlayerTrackingStats):
    """
    Statistics that measure possessions by a player while on the court.
    """
    _pt_measure_type=PtMeasureType.Possessions


class PlayerTracking_PullUpShot(_PlayerTrackingStats):
    """
    Statistics that measure pull up shots by a player while on the court.
    """
    _pt_measure_type=PtMeasureType.PullUpShot



class PlayerTracking_Rebounding(_PlayerTrackingStats):
    """
    Statistics that measure rebounding by a player while on the court.
    """
    _pt_measure_type=PtMeasureType.Rebounding

class PlayerTracking_Efficiency(_PlayerTrackingStats):
    """
    Statistics that measure efficiency for a player while on the court.
    """
    _pt_measure_type=PtMeasureType.Efficiency


class PlayerTracking_ElbowTouch(_PlayerTrackingStats):
    """
    Statistics that measure elbow touches by a player while on the court.
    """
    _pt_measure_type=PtMeasureType.ElbowTouch


class PlayerTracking_PostTouch(_PlayerTrackingStats):
    """
    Statistics that measure touches in the post by a player while on the court.
    """
    _pt_measure_type=PtMeasureType.PostTouch


class PlayerTracking_PaintTouch(_PlayerTrackingStats):
    """
    Statistics that measure touches in the paint by a player while on the court.
    """
    _pt_measure_type=PtMeasureType.PaintTouch
